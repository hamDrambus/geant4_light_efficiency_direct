...
// =======================================================================
#ifndef CustomTransportation_hh
#define CustomTransportation_hh 1
...
class CustomTransportation : public G4VProcess
{
	// Concrete class that does the geometrical transport 

public:  // with description

	CustomTransportation(G4int verbosityLevel = 1);
...
inline void
CustomTransportation::SetPropagatorInField(G4PropagatorInField* pFieldPropagator)
{
	fFieldPropagator = pFieldPropagator;
}

inline G4PropagatorInField* CustomTransportation::GetPropagatorInField()
{
	return fFieldPropagator;
}

inline G4bool CustomTransportation::DoesGlobalFieldExist()
{
...
inline void CustomTransportation::SetVerboseLevel(G4int verboseLev)
{
	fVerboseLevel = verboseLev;
}

inline G4int CustomTransportation::GetVerboseLevel() const
{
	return fVerboseLevel;
}

inline G4double CustomTransportation::GetThresholdWarningEnergy() const
{
	return fThreshold_Warning_Energy;
}

inline G4double CustomTransportation::GetThresholdImportantEnergy() const
{
	return fThreshold_Important_Energy;
}

inline G4int CustomTransportation::GetThresholdTrials() const
{
	return fThresholdTrials;
}

inline void CustomTransportation::SetThresholdWarningEnergy(G4double newEnWarn)
{
	fThreshold_Warning_Energy = newEnWarn;
}

inline void CustomTransportation::SetThresholdImportantEnergy(G4double newEnImp)
{
	fThreshold_Important_Energy = newEnImp;
}

inline void CustomTransportation::SetThresholdTrials(G4int newMaxTrials)
{
...
inline G4double CustomTransportation::GetMaxEnergyKilled() const
{
	return fMaxEnergyKilled;
}

inline G4double CustomTransportation::GetSumEnergyKilled() const
{
	return fSumEnergyKilled;
}

inline void CustomTransportation::ResetKilledStatistics(G4int report)
{
	if (report) {
		G4cout << " CustomTransportation: Statistics for looping particles " << G4endl;
...
inline void CustomTransportation::EnableShortStepOptimisation(G4bool optimiseShortStep)
{
	fShortStepOptimisation = optimiseShortStep;
}

inline G4bool CustomTransportation::EnableUseMagneticMoment(G4bool useMoment)
{
